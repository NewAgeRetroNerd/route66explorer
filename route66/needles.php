...
<main>
    <section class="city-header">
        <h2>Discover Needles, CA</h2>
        <img class="city-img" src="images/needles.jpg" alt="Needles">
        <p>Discover the warmth and desert beauty of Needles, California!</p>
    </section>
